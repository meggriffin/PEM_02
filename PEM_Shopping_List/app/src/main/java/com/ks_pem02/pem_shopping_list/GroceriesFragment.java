...
import static com.ks_pem02.pem_shopping_list.dummy.DummyContent.*;
...
public class GroceriesFragment extends Fragment implements AbsListView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (null != mListener) {
            ...
            mListener.onFragmentInteraction(content.getItems().get(position).id);
        }
    }
